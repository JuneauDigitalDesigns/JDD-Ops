 ...
 *
 * Client: Peak Home Services LLC — Orlando, FL
...
export const CONTENT: SiteContent = {
  ...
  trust: {
    ...
    logos: [
      "City of Orlando",
      "Bergmann Properties",
      "Orlando School District",
      "EPA 608 Certified",
      "NATE-Certified",
      "BBB Accredited",
      "Best of Orlando 2024",
    ],
  },

  // ── Hero ──────────────────────────────────────────────────────────────────
  hero: {
    eyebrow:          "Orlando's #1 Rated Home Services",
    ...
    secondaryCta:     "Call (407) 555-0142",
    trust:            "We're the only Orlando contractor offering same-day HVAC diagnostics with a price-lock guarantee.",
  ...
  about: {
    ...
    body:    "Peak Home Services has been keeping Orlando homes comfortable since 2011. From routine maintenance to emergency callouts in the middle of winter, our team shows up fast and fixes it right. We believe in transparent pricing, honest advice, and work that lasts.",

    pillars: [
      { k: "shield", t: "Licensed & Insured",    d: "Every technician is fully licensed, bonded, and covered so you have zero liability." },
      { k: "clock",  t: "Same-Day Service",       d: "We keep trucks staged around Orlando to respond within hours — not days." },
      { k: "tag",    t: "Price-Lock Guarantee",   d: "The quote we give you is the price you pay. No invoice surprises." },
      { k: "star",   t: "4.9-Star Rated",         d: "Over 300 verified reviews across Google and Facebook from real Orlando customers." },
    ],
    ...
    items: [
      {
        ...
        d: "We install and replace all major HVAC brands. Mini-splits, ducted systems, and heat pumps — sized right for Florida's climate.",
        tag: "Heating & Cooling",
        image: {
  ...
  work: {
    ...
    projects: [
      ...
      {
        t:       "Orlando School District — Boiler Replacement",
        loc:     "Orlando, FL",
        yr:      "2024",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Our emergency line operates 24/7. In most cases we can have a technician on-site within 2 hours anywhere in the Orlando area.",
      },
      {
        q: "What areas do you serve?",
        a: "We serve Orlando, Winter Park, Maitland, Lake Nona, and surrounding communities within the Orlando metropolitan area.",
      },
      {
        q: "Are your technicians licensed and insured?",
        a: "Yes. All technicians hold current Florida contractor licenses and are covered by liability insurance and workers' compensation.",
      },
    ],
  },
  ...
  // ── Footer ────────────────────────────────────────────────────────────────
  footer: {
    blurb: "Peak Home Services has been Orlando's go-to HVAC, plumbing, and home repair contractor since 2011. Licensed, insured, and always available when you need us most.",
    ...
    social: [
      { label: "Instagram", href: "https://instagram.com/peakhomeservicesorlando" },
      { label: "Facebook",  href: "https://facebook.com/peakhomeservicesorlando" },
    ],
  ...
  // ── SEO ───────────────────────────────────────────────────────────────────
  seo: {
    title:             "Peak Home Services | HVAC & Plumbing in Orlando, FL",
    description:       "Orlando's trusted HVAC, plumbing, and home services company. Same-day diagnostics, price-lock guarantee, and 24/7 emergency support.",
