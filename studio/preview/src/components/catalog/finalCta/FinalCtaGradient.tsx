      ...
      <div className="relative mx-auto max-w-2xl px-6">
        ...
        >
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            <a
              href="#contact"
              className="inline-block rounded-lg bg-accent px-8 py-4 font-semibold text-bg shadow-lg shadow-accent/25 transition-all hover:opacity-90 hover:shadow-accent/40"
            >
              {finalCta.cta}
            </a>
            {finalCta.secondary && (
