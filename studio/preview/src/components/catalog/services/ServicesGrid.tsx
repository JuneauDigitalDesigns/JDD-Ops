            ...
            return (
              ...
              >
                ...
                <div className="flex flex-1 flex-col p-7">
                  ...
                  <span className="mt-4 text-xs font-medium uppercase tracking-widest text-accent">{s.tag}</span>
                  <h3 className="mt-2 font-heading text-xl text-ink">{s.t}</h3>
                  <p className="mt-2 flex-1 text-inkSoft">{s.d}</p>
