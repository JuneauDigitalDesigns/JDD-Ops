  ...
  return (
    <section id="contact" className="bg-accent px-6 py-20">
      <div className="mx-auto max-w-4xl text-center">
        ...
        >
          <p className="text-xs font-semibold uppercase tracking-widest text-accentFg/70">{finalCta.eyebrow}</p>
          <h2 className="mt-2 font-heading text-3xl text-accentFg">{finalCta.headline}</h2>
        </motion.div>
