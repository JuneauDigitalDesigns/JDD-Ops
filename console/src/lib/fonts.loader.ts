...
// shift). Exposes a combined className of CSS-variable classes to attach to <html> so the
// families referenced by fonts.ts stacks (var(--font-inter), …) resolve everywhere.
