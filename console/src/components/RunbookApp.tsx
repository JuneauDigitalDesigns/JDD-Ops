...
import { ArrowsClockwise, Wrench, Compass, Stack, ArrowRight } from '@phosphor-icons/react';
    ...
    <div className="relative z-10 flex h-screen flex-col">
      ...
      <header className="flex items-center justify-between gap-4 border-b border-rule px-7 py-4">
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Cross-link back to the Studio site builder. */}
          <Link href="/build" className="btn btn-sm btn-primary">
            <Stack size={13} /> Build <ArrowRight size={12} weight="bold" />
          </Link>
        </div>
      </header>
