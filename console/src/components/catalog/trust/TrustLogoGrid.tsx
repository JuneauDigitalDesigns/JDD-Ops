...
export default function TrustLogoGrid({ content = CONTENT }: { content?: SiteContent }) {
      ...
      >
        ...
        <div className="lg:border-r lg:border-rule lg:pr-12">
          {review ? (
            ...
            <div>
              <p className="text-xs font-semibold uppercase tracking-widest text-accent"><E p="trust.label">{trust.label}</E></p>
