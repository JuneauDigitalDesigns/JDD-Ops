...
export default function AboutStory({ content = CONTENT }: { content?: SiteContent }) {
    ...
    <section id="about" className="bg-bg py-24">
      <div className="mx-auto max-w-4xl px-6">
        ...
        >
          ...
          <h2 className="mt-4 font-heading text-4xl text-ink md:text-5xl"><E p="about.title">{about.title}</E></h2>
          <p className="mt-6 text-lg leading-relaxed text-inkSoft"><E p="about.body">{about.body}</E></p>
        </motion.div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="font-heading text-lg font-semibold text-ink"><E p={`about.pillars.${i}.t`}>{p.t}</E></h3>
                    <p className="mt-2 leading-relaxed text-inkSoft"><E p={`about.pillars.${i}.d`}>{p.d}</E></p>
                  </div>
                </motion.div>
              );
            })}
