...
export default function WorkSpotlight({ content = CONTENT }: { content?: SiteContent }) {
            ...
            <div className="relative overflow-hidden" style={{ aspectRatio: '16/9' }}>
              {featured.image?.url ? (
                ...
                <div className="flex h-full w-full items-center justify-center bg-bgSoft bg-[repeating-linear-gradient(45deg,transparent,transparent_10px,rgba(0,0,0,0.03)_10px,rgba(0,0,0,0.03)_20px)]">
                  <span className="font-sans text-xs uppercase tracking-widest text-inkSoft"><E p="work.projects.0.caption">{featured.caption}</E></span>
                </div>
              )}
            </div>
            <div className="p-7">
              ...
              <h3 className="mt-1 font-heading text-xl font-bold text-ink"><E p="work.projects.0.t">{featured.t}</E></h3>
              <p className="mt-2 leading-relaxed text-inkSoft"><E p="work.projects.0.caption">{featured.caption}</E></p>
              <div className="mt-4 flex gap-6 text-sm">
                <div><span className="text-xs font-semibold uppercase tracking-wider text-accent">Location</span><p className="mt-0.5 text-ink"><E p="work.projects.0.loc">{featured.loc}</E></p></div>
                <div><span className="text-xs font-semibold uppercase tracking-wider text-accent">Size</span><p className="mt-0.5 text-ink"><E p="work.projects.0.size">{featured.size}</E></p></div>
                {featured.yr && <div><span className="text-xs font-semibold uppercase tracking-wider text-accent">Year</span><p className="mt-0.5 text-ink"><E p="work.projects.0.yr">{featured.yr}</E></p></div>}
              </div>
            </div>
          </motion.article>
              ...
              {rest.map((p, i) => (
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <h3 className="mt-0.5 font-heading text-sm font-semibold leading-snug text-ink"><E p={`work.projects.${i + 1}.t`}>{p.t}</E></h3>
