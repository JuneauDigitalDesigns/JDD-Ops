    ...
    <section id="cta" className="relative overflow-hidden bg-ink py-24">
      ...
      <div className="relative mx-auto max-w-3xl px-6">
        ...
        >
          ...
          <h2 className="mt-3 font-heading text-4xl text-bg md:text-5xl"><E p="finalCta.headline">{finalCta.headline}</E></h2>
          <p className="mx-auto mt-4 max-w-xl text-balance text-bg/70"><E p="finalCta.sub">{finalCta.sub}</E></p>
        </motion.div>
